...
<div class="row justify-content-between">
        <div class="col-2">
          <br>
          <a href="<?=base_url("admin/index");?>" type="button" class="btn btn-danger">Cancelar</a>
        </div>
      </div>
...
<div class="row">
  <div class="col-md-7">
    <div class="mb-3">
      <label for="año" class="form-label">Año <span id="count"></span></label>
      <textarea class="form-control" id="año" name="año" rows="3"><?=$semana['año'];?></textarea>
      <?php if($validation->getError('año')) {?>
        <div class="alert alert-danger mt-2">
        <?= $validation->getError('año'); ?>
        </div>
      <?php }?> 
    </div> 
  </div>
