    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="row justify-content-between">
        <div class="col-2">
          ...
          <a href="<?=base_url("Home/nueva");?>" type="button" class="btn btn-primary">Nuevo año</a>
      ...
      <div class="table-responsive">
        <table class="table table-sm table-hover">
          ...
          <?php if($semanas){
            ...
            <td><span class="badge bg-info text-dark"><?=$semana->usuarios;?></span></td>
            <td><?=$semana->año;?></td>
            <td> 
            <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
            <a href="<?=base_url("Home/bitacora/{$semana->año}/{$semana->semana}/{$semana->usuario}");?>" class="btn btn-primary">Ver</a>
            <?php if($id == 1){ ?>
            <a href="" class="btn btn-danger" onclick="return confirm('Deseas eliminar?')">Eliminar</a>
            <?php } ?>
