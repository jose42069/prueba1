    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <?php if($status == 1){ ?>
          <li class="nav-item">
            <a class="nav-link" href="<?=base_url("Home/clientes");?>">
              <span data-feather="file"></span>
              Clientes
            </a>
          </li>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="row justify-content-between">
        <div class="col-2">
          ...
          <a href="<?=base_url("Home/nuevo_proyecto");?>" type="button" class="btn btn-primary">Nuevo proyecto</a>
      ...
      <div class="table-responsive">
        <table class="table table-sm table-hover">
          ...
          <tbody>
          <?php if($proyectos){
            foreach ($proyectos as $semana) { ?>
            <tr>
            <td><?=$semana->proyecto;?></td>
            
            <td> 
            <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
            <a href="<?=base_url("Home/editar_proyecto/{$semana->id}");?>" class="btn btn-primary">Editar</a>
            
            <a href="<?=base_url("Home/eliminar_proyecto/{$semana->id}");?>" class="btn btn-danger" onclick="return confirm('Deseas eliminar?')">Eliminar</a>
